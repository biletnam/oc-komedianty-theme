/*
 ...
 MyFonts Webfont Build ID 3048466, 2015-06-24T16:52:45-0400
 ...
 Webfont: ProbaPro-Italic by Mint Type
 URL: http://www.myfonts.com/fonts/konstantynov/proba-pro/italic/

 Webfont: ProbaPro-Regular by Mint Type
 URL: http://www.myfonts.com/fonts/konstantynov/proba-pro/regular/


 License: http://www.myfonts.com/viewlicense?type=web&buildid=3048466
 Licensed pageviews: 10,000
 Webfonts copyright: Copyright (c) 2014 by Andriy Konstantynov. All rights reserved.

 ? 2015 MyFonts Inc
*/
var protocol=document.location.protocol;"https:"!=protocol&&(protocol="http:");var count=document.createElement("script");count.type="text/javascript";count.async=!0;count.src=protocol+"//hello.myfonts.net/count/2e8412";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if("undefined"==typeof woffEnabled)var woffEnabled=!0;var svgEnabled=1,woff2Enabled=1;
...
for(var fonts=[{fontFamily:"ProbaPro",fontWeight:"normal",fontStyle:"italic",url:wfpath+"2E8412_0"+suffix+"_0."+webfontType},{fontFamily:"ProbaPro",fontWeight:"normal",fontStyle:"normal",url:wfpath+"2E8412_1"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':"ttf"==webfontType?'format("truetype")':"eot"==webfontType?"":'format("'+webfontType+'")',css=css+("@font-face{font-family: "+fonts[i].fontFamily+";src:url("+fonts[i].url+")"+format+
